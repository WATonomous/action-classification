...
if __name__ == '__main__':
    ffw_s = parse_slowfast(open('./result_scripts/ffw_s.txt', 'r'))
    ffw_p = parse_slowfast(open('./result_scripts/ffw_p.txt', 'r'))
    acar_p = parse_acar(open('./result_scripts/acar_p.txt', 'r'))
    ...
    pyplot.xlabel('Epoch')
    pyplot.ylabel('mAP%', rotation=0, labelpad=20)
    pyplot.legend()
